# Cosmetic component
## サイト概要
管理者側が、化粧品の登録(化粧品の詳細や化粧品成分等)を行います。
利用者が化粧品の検索や、化粧品成分の検索（除外したい成分）の結果を表示します。<br>いいねした商品はAmazonや楽天等と結びつけて、いいねした商品一覧から遷移します。

### サイトテーマ
自分にあった化粧品を見つけるために
### テーマを選んだ理由
成分から化粧品を探すことは可能ですが、成分を除外したものから化粧品を探すサイトがあるとより便利だと思ったからです。
### ターゲットユーザ
